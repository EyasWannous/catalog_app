...
import 'package:catalog_app/features/categroy/presentation/widgets/hierarchical_category_card.dart';
...
class HierarchicalCategoriesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        floatingActionButton: isAdmin ? _buildFloatingActionButton(context) : null,
        body: Center(
      ...
      builder: (context) => FloatingActionButton(
        onPressed: () async {
          ...
          await context.push(
            ...
            extra: {
              'category': null,
              'parentId': cubit.currentParentId, // Pass current parent for hierarchy
            },
          ).then((_) {
            if (context.mounted) {
              ...
              if (cubit.isAtRootLevel) {
                ...
                cubit.getCategoriesByParent(cubit.currentParentId!, isInitialLoad: true);
              }
            }
          });
        },
                        ...
                        return Row(
                          children: [
                            ...
                            Text(
                              category.name,
                              style: TextStyle(
                                color: isLast ? Colors.black87 : Color(0xFFFF8A95),
                                fontSize: 14 * ResponsiveUtils.getFontSizeMultiplier(context),
  ...
  Widget _buildCategoriesContent(BuildContext context, CategoriesState state, bool isAdmin) {
    ...
    if (state is CategoriesLoaded) {
      ...
      return _buildCategoriesList(context, state.categories, state.isLoadingMore, state.hasMore, isAdmin);
    }
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Container(
              padding: EdgeInsets.all(ResponsiveUtils.getResponsiveSpacing(context, 20.0)),
              decoration: BoxDecoration(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              if (index < categories.length) {
                ...
                return Padding(
                  padding: EdgeInsets.all(ResponsiveUtils.getResponsiveSpacing(context, 16.0)),
