          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Please wait while we fetch products from ${widget.categoryTitle ?? 'this category'}',
                  style: TextStyle(
                    fontSize:
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'No products found for "$_currentSearchQuery" in ${widget.categoryTitle}\nTry searching with different keywords',
                    style: TextStyle(
                      fontSize:
                  ...
                  children: [
                    ...
                    Text(
                      _currentSearchQuery.isNotEmpty
                          ? 'Search results in ${widget.categoryTitle}'
                          : 'Products in ${widget.categoryTitle}',
                      style: TextStyle(
                        fontSize:
                            14.0 *
                            ResponsiveUtils.getFontSizeMultiplier(context),
