    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            'You can only add up to $maxImages images per product.',
          ),
          actions: [
            TextButton(
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            'Please select an image smaller than ${maxImageSizeMB}MB.',
          ),
          actions: [
            TextButton(
              onPressed: () => Navigator.of(context).pop(),
  ...
  bool _validateForm() {
    ...
    if (categoryId == null || categoryId.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Category ID is required. Please select a category first.',
          ),
          backgroundColor: Colors.red,
        ),
      );
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 4),
            Text(
              _canAddMoreImages() ? 'Add Images' : 'Limit Reached',
              style: TextStyle(
