...
class _SyrianPriceAdminWidgetState extends State<SyrianPriceAdminWidget> {
            ...
            content: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Helper text
                  Text(
                    'This price will be cached and shown to all users',
                    style: TextStyle(
                      fontSize:
  ...
  Future<void> _updateSyrianPrice(String newPrice) async {
    if (newPrice.isEmpty) {
      _showErrorMessage('Please enter a valid Syrian price');
      return;
    }
    ...
    try {
      ...
      result.fold(
        (failure) {
          _showErrorMessage('Failed to update Syrian price. Please try again.');
        },
        (updatedProduct) {
          Navigator.of(context).pop();
          _showSuccessMessage('Syrian price updated successfully!');
