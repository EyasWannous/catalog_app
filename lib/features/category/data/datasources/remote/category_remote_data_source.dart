...
class CategoryRemoteDataSourceImpl implements CategoryRemoteDataSource {
  ...
  Future<CategoriesResponseModel> getCategoriesByParent({
    ...
    try {
      ...
      final filteredCategories = categoriesResponse.categories
          .where((category) {
            final matches = parentId == null
  ...
  Future<CategoryModel> postCategory(
    ...
    try {
      final data = {'Id': 0, 'Name': name, 'Description': description};
  ...
  Future<void> updateCategory(
    ...
    try {
      final data = {'Id': id, 'Name': name, 'Description': description};
